...
public class AppData {
   ...
   /* public static String APPID = "89gnhe";
    ...
    //public static String LAMS_SaveAttendance ="http://171.16.1.33/GSPPI_API_V2/api/Attendance/LAMS_SaveAttendance";
    ...
    public static String LAMS_SaveAttendanceRegularization =newv2url+"Attendance/LAMS_SaveAttendanceRegularization";
    public static String LAMS_DropDownData =newv2url+"Attendance/LAMS_DropDownData";
    public static String LAMS_AllApplicationView =newv2url+"Attendance/LAMS_AllApplicationView";
    public static String LAMS_Save_OD_CO_WFH =newv2url+"LAMS_EmployeeOTandODAdjustment/SaveODandOTapplication";
    public static String LAMS_AttnRegularisationDate =newv2url+"Attendance/LAMS_AttnRegularisationDate";
    public static String LAMS_DailyAttendanceReportEmp =newv2url+"Attendance/LAMS_DailyAttendanceReportEmp";
    public static String LAMS_ViewHolidayList =newv2url+"Attendance/LAMS_ViewHolidayList";
