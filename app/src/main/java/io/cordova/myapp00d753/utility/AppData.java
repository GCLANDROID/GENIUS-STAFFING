...
public class AppData {
   ...
   /* public static String APPID = "89gnhe";
    ...
    public static String LAMS_SaveAttendanceRegularization ="http://171.16.1.33/GSPPI_API_V2/api/Attendance/LAMS_SaveAttendanceRegularization";
    ...
    public static String LAMS_ViewHolidayList ="http://171.16.1.33/GSPPI_API_V2/api/Attendance/LAMS_ViewHolidayList";
