...
public class AttendancereportModule {
    String attendanceDate,attendanceInTime,attendanceOutTime,attendanceLocation,attendanceReply,attendanceType,empName;

    public AttendancereportModule(String attendanceDate, String attendanceInTime, String attendanceOutTime, String attendanceLocation, String attendanceReply, String attendanceType, String empName) {
