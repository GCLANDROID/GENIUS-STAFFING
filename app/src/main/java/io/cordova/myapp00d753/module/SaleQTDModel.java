...
public class SaleQTDModel {
    String target,sold,quater,percentage,month,finYear,preYear,preTarget,preSold,prePercentage,growth,week;

    public SaleQTDModel(String target, String sold, String quater,String percentage) {
        this.target = target;
        this.sold = sold;
        this.quater = quater;
