...
public class JLLQuestionAdapter extends RecyclerView.Adapter<JLLQuestionAdapter.MyViewHolder> {
        ...
        myViewHolder.llExcited.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (qeuModel.isSelected()) {
                    ...
                    ((FeedBackRatingForJLLActivity) context).updateStatus(i, true);



                } else {

                    ((FeedBackRatingForJLLActivity) context).updateStatus(i, false);
    ...
    public JLLQuestionAdapter(ArrayList<QuestionModel> itemList, Context context) {
