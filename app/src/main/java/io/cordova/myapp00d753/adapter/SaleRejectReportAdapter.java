...
public class SaleRejectReportAdapter extends RecyclerView.Adapter<SaleRejectReportAdapter.MyViewHolder> {
            ...
            myViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (attandanceModel.isSelected()) {
                        ...
                        ((SaleRejectFragment) fm).updateAttendanceStatus(i, true );



                    } else {
                        myViewHolder.imgLike.setVisibility(View.GONE);
                        ((SaleRejectFragment) fm).updateAttendanceStatus(i, false );
    ...
    public SaleRejectReportAdapter(ArrayList<SaleApprovalReportModel> itemList, Context context, Fragment fm) {
