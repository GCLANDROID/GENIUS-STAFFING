...
public class JLLQuestion1Adapter extends RecyclerView.Adapter<JLLQuestion1Adapter.MyViewHolder> {
        ...
        myViewHolder.llExcited.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (qeuModel.isSelected()) {
                    ...
                    itemList.get(i).setAnswervalue("#5");
                    myViewHolder.tvRate.setVisibility(View.VISIBLE);
                    myViewHolder.tvRate.setText("Rate:5");

                    notifyDataSetChanged();
                    ((FeedBackRatingForJLLActivity) context).updateStatus1(i, true);



                } else {

                    ((FeedBackRatingForJLLActivity) context).updateStatus1(i, false);
        ...
        myViewHolder.llVeryGood.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (qeuModel.isSelected()) {
                    ...
                    itemList.get(i).setAnswervalue("#4");
                    itemList.get(i).setSelected(true);
        ...
        myViewHolder.llGood.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (qeuModel.isSelected()) {
                    ...
                    itemList.get(i).setAnswervalue("#3");
        ...
        myViewHolder.llAverage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (qeuModel.isSelected()) {
                    ...
                    itemList.get(i).setAnswervalue("#2");
                    itemList.get(i).setSelected(true);
    ...
    public JLLQuestion1Adapter(ArrayList<Question1Model> itemList, Context context) {
