...
import io.cordova.myapp00d753.activity.SupLeaveApprovalActivity;
import io.cordova.myapp00d753.fragment.ApproverFragment;
import io.cordova.myapp00d753.module.ApprovalModel;

public class SupLeaveApproverAdapter extends RecyclerView.Adapter<SupLeaveApproverAdapter.MyViewHolder> {
        ...
        myViewHolder.llTick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (approvalModel.isSelected()) {
                    ...
                    ((SupLeaveApprovalActivity) mContex).updateAttendanceStatus(i, true );
                    ...
                    myViewHolder.imgTick.setVisibility(View.GONE);
                    ((SupLeaveApprovalActivity) mContex).updateAttendanceStatus(i, false);
    ...
    public SupLeaveApproverAdapter(ArrayList<ApprovalModel> itemList,  Context mContext) {
