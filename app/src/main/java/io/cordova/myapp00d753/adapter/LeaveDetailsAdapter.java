...
public class LeaveDetailsAdapter extends RecyclerView.Adapter<LeaveDetailsAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, @SuppressLint("RecyclerView") final int i) {
        ...
        myViewHolder.tvApprovalDate.setText(TimeDateString.changeDateStringToIndianDateFormatAndMonthInSpellingSortFrom(itemList.get(i).getApprovedDate()));
        ...
        //approver
        myViewHolder.tvApprovedBy.setText(TimeDateString.changeDateStringToIndianDateFormatAndMonthInSpellingSortFrom(itemList.get(i).getApprovedDate()));
        ...
        myViewHolder.tvLeaveValue.setText("Day(s):");
