...
public class HolidayCustomAdapter extends ArrayAdapter<String> {
    public HolidayCustomAdapter(@NonNull Context context, ArrayList<String> holidayList) {
        super(context,0, holidayList);
    }
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentItem != null) {
            txtShiftTime.setText(currentItem);
        }
        return convertView;
    }
}
