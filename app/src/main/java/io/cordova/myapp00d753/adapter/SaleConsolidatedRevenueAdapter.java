...
public class SaleConsolidatedRevenueAdapter extends RecyclerView.Adapter<SaleConsolidatedRevenueAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.tvFinTarget.setText( itemList.get(i).getCyTarget() + " Lacs");
        myViewHolder.tvFinSold.setText( itemList.get(i).getCySold() + " Lacs");



        myViewHolder.tvPreYear.setText("2019-2020");
        myViewHolder.tvPreTarget.setText(itemList.get(i).getLyTarget() + " Lacs");
        myViewHolder.tvPreSold.setText( itemList.get(i).getLySold() + " Lacs");
    ...
    public SaleConsolidatedRevenueAdapter(ArrayList<SaleConsolidatedModel> itemList) {
