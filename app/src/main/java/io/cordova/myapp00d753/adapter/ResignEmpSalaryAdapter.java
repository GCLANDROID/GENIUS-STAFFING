...
import io.cordova.myapp00d753.activity.ResignEmpSalaryActivity;
import io.cordova.myapp00d753.activity.SalaryActivity;
import io.cordova.myapp00d753.module.SalaryModule;

public class ResignEmpSalaryAdapter extends RecyclerView.Adapter<ResignEmpSalaryAdapter.MyViewHolder> {
        ...
        myViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (salryinfoList.get(i).getIsPaidService()==1){
                    ((ResignEmpSalaryActivity)context).paymentOption(i);
    ...
    public ResignEmpSalaryAdapter(ArrayList<SalaryModule> salryinfoList, Context context) {
