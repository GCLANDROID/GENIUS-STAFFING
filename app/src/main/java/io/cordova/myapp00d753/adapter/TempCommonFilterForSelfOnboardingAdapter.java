...
public class TempCommonFilterForSelfOnboardingAdapter extends RecyclerView.Adapter<TempCommonFilterForSelfOnboardingAdapter.MyViewHolder> /*implements Filterable*/ {

    Context context;
    ArrayList<MainDocModule> itemList;
    ArrayList<MainDocModule> allItemList;
    String selectFor;
    public TempCommonFilterForSelfOnboardingAdapter(Context context, ArrayList<MainDocModule> itemList, String selectFor) {
        ...
        holder.txtFilterItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (selectFor.equalsIgnoreCase("bank_name")){
                    ((SelfOnboardingChatBotActivity) context).setText(itemList.get(position).getDocID(),itemList.get(position).getDocumentType(),selectFor);
                } else {
                    ((SelfOnboardingChatBotActivity) context).setText(itemList.get(position).getDocID(),itemList.get(position).getDocumentType(),selectFor);
                }
