...
import io.cordova.myapp00d753.activity.SupSaleTargetActivity;
import io.cordova.myapp00d753.module.EmpSaleModel;

public class EmpTargetAdapter extends RecyclerView.Adapter<EmpTargetAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.tvPercentage.setText("Target Percentage: "+itemList.get(i).getPercenTage());
        myViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(context, SupSaleTargetActivity.class);
    ...
    public EmpTargetAdapter(ArrayList<EmpSaleModel> itemList, Context context) {
