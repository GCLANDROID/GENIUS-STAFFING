...
public class CheckOutAttendanceAdapter extends RecyclerView.Adapter<CheckOutAttendanceAdapter.MyViewHolder> {
    ArrayList<CheckInOutAttendanceModel>itemList=new ArrayList<>();
    Context context;
    @NonNull
    @Override
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.check_out_attendance_row,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.tvTime.setText(model.getOuttime());
        myViewHolder.tvInTime.setText(model.getInTime());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView tvEmpName,tvEmpID,tvTime,tvInTime;
    ...
    public CheckOutAttendanceAdapter(ArrayList<CheckInOutAttendanceModel> itemList, Context context) {
