...
public class AllIndiaDataFragment extends Fragment {
    View view;
    ...
    public void loadProductWiseFragment() {
        ...
        AllIndiaProductWiseFragment pfragment=new AllIndiaProductWiseFragment();
    ...
    public void loadRevenueWiseWiseFragment() {
        ...
        FragmentManager manager = getChildFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        AllIndiaRevenueWiseFragment pfragment=new AllIndiaRevenueWiseFragment();
        transaction.replace(R.id.frameLayout2, pfragment);
        transaction.commit();
