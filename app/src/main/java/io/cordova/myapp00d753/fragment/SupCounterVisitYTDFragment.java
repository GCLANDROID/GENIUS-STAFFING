...
public class SupCounterVisitYTDFragment extends Fragment {
    ...
    public void loadNormalYTDFragment() {
        ...
        SupCounterVisitNormalYTDFragment pfragment=new SupCounterVisitNormalYTDFragment();
    ...
    public void loadGraphicalYTDFragment() {
        ...
        FragmentManager manager = getChildFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        SupCounterVisitGraphicalYTDFragment pfragment=new SupCounterVisitGraphicalYTDFragment();
        transaction.replace(R.id.frameLayout1, pfragment);
        transaction.commit();
