 ...
 */
public class SupWTDSaleFragment extends Fragment {
   ...
   View view;
    ...
    public void loadNormalQTDFragment() {
        ...
        SupNormalWTDSaleFragment pfragment=new SupNormalWTDSaleFragment();
    ...
    public void loadGraphicalQTDFragment() {
        ...
        FragmentManager manager = getChildFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        SupGraphicalWTDSaleFragment pfragment=new SupGraphicalWTDSaleFragment();
        transaction.replace(R.id.frameLayout1, pfragment);
        transaction.commit();
