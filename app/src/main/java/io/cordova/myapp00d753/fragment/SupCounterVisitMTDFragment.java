...
public class SupCounterVisitMTDFragment extends Fragment {
    View view;
    ...
    public void loadNormalYTDFragment() {
        ...
        SupCounterVisitNormalMTDFragment pfragment=new SupCounterVisitNormalMTDFragment();
    ...
    public void loadGraphicalYTDFragment() {
        ...
        FragmentManager manager = getChildFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        CounterVisitGraphicalMTDFragment pfragment=new CounterVisitGraphicalMTDFragment();
        transaction.replace(R.id.frameLayout1, pfragment);
        transaction.commit();
