...
public class SupCounterVisitQTDFragment extends Fragment {
    ...
    public void loadNormalYTDFragment() {
        ...
        SupCounterVisitNormalQTDFragment pfragment=new SupCounterVisitNormalQTDFragment();
    ...
    public void loadGraphicalYTDFragment() {
        ...
        FragmentManager manager = getChildFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        CounterVisitGraphicalQTDFragment pfragment=new CounterVisitGraphicalQTDFragment();
        transaction.replace(R.id.frameLayout1, pfragment);
        transaction.commit();
