...
public class CounterVisitYTDFragment extends Fragment {
    ...
    public void loadNormalYTDFragment() {
        ...
        CounterVisitNormalYTDFragment pfragment=new CounterVisitNormalYTDFragment();
    ...
    public void loadGraphicalYTDFragment() {
        ...
        FragmentManager manager = getChildFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        CounterVisitGraphicalYTDFragment pfragment=new CounterVisitGraphicalYTDFragment();
        transaction.replace(R.id.frameLayout1, pfragment);
        transaction.commit();
