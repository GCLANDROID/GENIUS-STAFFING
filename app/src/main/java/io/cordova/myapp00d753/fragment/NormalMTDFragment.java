...
public class NormalMTDFragment extends Fragment {
    ...
    private void getItemList() {
        ...
        progressBar.show();
        String surl = AppData.url + "get_EmployeeSalesReport?ClientID="+pref.getEmpClintId()+"&UserID="+pref.getEmpId()+"&FinancialYear="+financialYear+"&Month="+month+"&RType=MTD&Operation=2&SecurityCode="+pref.getSecurityCode();
        Log.d("input", surl);
