...
public class BlueDartAttenDanceDashboardActivity extends AppCompatActivity implements View.OnClickListener, OnNavigationButtonClickedListener {
...
//
        ...
        final SimpleTooltip tooltip = new SimpleTooltip.Builder(BlueDartAttenDanceDashboardActivity.this)
                .anchorView(imgMenu)
    ...
    public void onClick(View view) {
        if (view == imgMenu) {
            ...
            Intent intent = new Intent(BlueDartAttenDanceDashboardActivity.this, BlueDartAttendanceManageActivity.class);
            ...
            Intent intent = new Intent(BlueDartAttenDanceDashboardActivity.this, AttendanceReportActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
        } else if (view == llBackAttendance) {
            Intent intent = new Intent(BlueDartAttenDanceDashboardActivity.this, BacklogAttendanceActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
            ...
            Intent intent = new Intent(BlueDartAttenDanceDashboardActivity.this, QRCodeScannerActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
        } else if (view == btnLeave) {
            Intent intent = new Intent(BlueDartAttenDanceDashboardActivity.this, LeaveApplicationActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
        } else if (view == tvOK) {
            lnStatus.setVisibility(View.GONE);
    ...
    private void weeklyfunction() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, surl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(BlueDartAttenDanceDashboardActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                progressBar.dismiss();
                Toast.makeText(BlueDartAttenDanceDashboardActivity.this, "volly 2" + error.toString(), Toast.LENGTH_LONG).show();
    ...
    private void successAlert(String text) {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(BlueDartAttenDanceDashboardActivity.this, R.style.CustomDialogNew);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Intent intent = new Intent(BlueDartAttenDanceDashboardActivity.this, AttenDanceManageWithShiftActivity.class);
                            intent.putExtra("intt", "2");
                            ...
                            e.printStackTrace();
                            Intent intent = new Intent(BlueDartAttenDanceDashboardActivity.this, EmployeeDashBoardActivity.class);
                            startActivity(intent);
                            Toast.makeText(BlueDartAttenDanceDashboardActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
