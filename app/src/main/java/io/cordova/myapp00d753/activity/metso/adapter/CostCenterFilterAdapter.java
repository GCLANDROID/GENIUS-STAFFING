...
public class CostCenterFilterAdapter extends RecyclerView.Adapter<CostCenterFilterAdapter.MyViewHolder>{
    ...
    public CostCenterFilterAdapter(Context context, ArrayList<SpineerItemModel> costCenterList) {
