...
public class SupSaleReportActivity extends AppCompatActivity {
    ...
    public void loadYTDFragment() {
        ...
        tvToolBar1.setText(pref.getFinacialYear());
    ...
    public void loadMTDFragment() {
        ...
        tvToolBar1.setText(pref.getMonth()+" "+pref.getFinacialYear());
    ...
    private void serachDialog(){
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SupSaleReportActivity.this, R.style.CustomDialogNew);
