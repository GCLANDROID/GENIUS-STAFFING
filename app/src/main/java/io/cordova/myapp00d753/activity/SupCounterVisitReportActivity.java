...
import io.cordova.myapp00d753.fragment.CounterVisitMTDFragment;
import io.cordova.myapp00d753.fragment.CounterVisitQTDFragment;
import io.cordova.myapp00d753.fragment.CounterVisitWTDFragment;
import io.cordova.myapp00d753.fragment.CounterVisitYTDFragment;
import io.cordova.myapp00d753.fragment.DailyCounterVisitReportFragment;
import io.cordova.myapp00d753.fragment.SupCounterVisitMTDFragment;
import io.cordova.myapp00d753.fragment.SupCounterVisitQTDFragment;
import io.cordova.myapp00d753.fragment.SupCounterVisitWTDFragment;
import io.cordova.myapp00d753.fragment.SupCounterVisitYTDFragment;
import io.cordova.myapp00d753.fragment.SupDailyCounterVisitReportFragment;
import io.cordova.myapp00d753.utility.Pref;

public class SupCounterVisitReportActivity extends AppCompatActivity {
    ...
    TextView tvYear,tvMonth,tvLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_counter_visit_report);
        initView();
        serachDialog();
        onClick();
    }
    ...
    private void initView(){
        ...
        tvEmpName.setText(empName+" ("+empId+" )");
        ...
        tvLocation.setText(branch+" - "+zone);
    ...
    public void loadYTDFragment() {
        ...
        SupCounterVisitYTDFragment pfragment=new SupCounterVisitYTDFragment();
        ...
        tvToolBar.setText("Yearly Visit Report");
    ...
    public void loadQTEDFragment() {
        ...
        FragmentManager manager = getSupportFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        SupCounterVisitQTDFragment efr=new SupCounterVisitQTDFragment();
        ...
        tvToolBar.setText("Quarterly Visit Report");
        tvToolBar1.setText(pref.getShowFinacialYear());
    ...
    public void loadMTDFragment() {
        ...
        FragmentManager manager = getSupportFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        SupCounterVisitMTDFragment htfragment=new SupCounterVisitMTDFragment();
        ...
        tvToolBar.setText("Monthly Visit Report");
    ...
    public void loadDailySaleFragment() {
        ...
        FragmentManager manager = getSupportFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        SupDailyCounterVisitReportFragment htfragment=new SupDailyCounterVisitReportFragment();
        transaction.replace(R.id.frameLayout, htfragment);
        transaction.commit();
        ...
        tvToolBar.setText("Daily Visit Report");
        tvToolBar1.setText(pref.getMonth()+" "+pref.getShowFinacialYear());
    ...
    public void loadWTDFragment() {
        ...
        FragmentManager manager = getSupportFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        SupCounterVisitWTDFragment htfragment=new SupCounterVisitWTDFragment();
        transaction.replace(R.id.frameLayout, htfragment);
        transaction.commit();
        ...
        tvToolBar.setText("Weekly Visit Report");
        tvToolBar1.setText(pref.getMonth()+" "+pref.getShowFinacialYear());
    ...
    private void serachDialog(){
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SupCounterVisitReportActivity.this, R.style.CustomDialogNew);
        ...
        tvSYear.setText("Select Visit Year");
        tvSMonth.setText("Select Visit Month");
