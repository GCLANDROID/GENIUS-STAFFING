...
public class BoschAttendanceReportActivity extends AppCompatActivity {

    RecyclerView rvAttendanceReport;
    ArrayList<BoschAttendanceReportModel> attendabceInfiList=new ArrayList<>();
    ...
    BoschAttendanceReportAdapter attendanceAdapter;
    String year;
    int y;
    TextView tvYear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bosch_attendance_report);
    ...
    private  void  initialize(){
        pref=new Pref(BoschAttendanceReportActivity.this);
        connectionCheck=new NetworkConnectionCheck(BoschAttendanceReportActivity.this);
        rvAttendanceReport=(RecyclerView)findViewById(R.id.rvAttendanceReport);
        layoutManager = new LinearLayoutManager(BoschAttendanceReportActivity.this, LinearLayoutManager.VERTICAL, false);
                        ...
                        try {
                            ...
                            if (responseStatus){
                                ...
                                for (int i = 0; i < responseData.length(); i++){
                                    ...
                                    String InMode=obj.optString("InMode");
                                    String OutMode=obj.optString("OutMode");
                                    String AttendanceType=obj.optString("AttendanceType");
                                    BoschAttendanceReportModel obj2 = new BoschAttendanceReportModel(AttendanceDate,AttendanceInDateTime,AttendanceOutDateTime,Address,ApproverStatus,AttendanceType,shift,location,InMode,OutMode);
    ...
    private  void setAdapter(){
        attendanceAdapter=new BoschAttendanceReportAdapter(BoschAttendanceReportActivity.this,attendabceInfiList);
    ...
    private void onClick(){
        ...
        imgSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(BoschAttendanceReportActivity.this, R.style.CustomDialogNew);
