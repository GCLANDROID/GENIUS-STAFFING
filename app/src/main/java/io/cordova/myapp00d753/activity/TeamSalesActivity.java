...
public class TeamSalesActivity extends AppCompatActivity {
    LinearLayout llZone, llBranch;
    ImageView imgZone, imgBranch;
    RecyclerView rvItem;
    ArrayList<TeamSaleModule> itemListForZone = new ArrayList<>();
    ArrayList<TeamSaleModule> itemListForBranch = new ArrayList<>();
    ArrayList<TeamSaleModule> itemListForNational = new ArrayList<>();
    ...
    LinearLayout llPAN;
    ImageView imgPAN,imgBack,imgHome;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_team_sales);
        initView();
        getItemListForNational();
        onClick();
    }
    ...
    private void initView() {
        ...
        pref=new Pref(TeamSalesActivity.this);
    ...
    private void onClick() {
        ...
        llViewAll.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(TeamSalesActivity.this, SupEmpSaleActivity.class);
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(TeamSalesActivity.this,SuperVisiorDashBoardActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void getItemListForZone() {
        final ProgressDialog pd=new ProgressDialog(TeamSalesActivity.this);
        pd.setMessage("Loading..");
        pd.setCancelable(false);
        pd.show();
        String surl = AppData.url + "get_EmployeeSalesReport?ClientID=" + pref.getEmpClintId() + "&UserID=" + pref.getEmpId() + "&FinancialYear=" + financialYear + "&Month=" + month + "&RType=Z&Operation=10&SecurityCode=" + pref.getSecurityCode();
        Log.d("input", surl);
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i=0;i<responseData.length();i++) {
                                    ...
                                    String TotalCount = obj.optString("TotalCount");
                                    String BranchID = "0";

                                    TeamSaleModule cModel=new TeamSaleModule(ZoneID,Zonename,TotalCount);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(TeamSalesActivity.this);
    ...
    private void getItemListForNational() {
        final ProgressDialog pd=new ProgressDialog(TeamSalesActivity.this);
        pd.setMessage("Loading..");
        pd.setCancelable(false);
        pd.show();
        String surl = AppData.url + "get_EmployeeSalesReport?ClientID=" + pref.getEmpClintId() + "&UserID=" + pref.getEmpId() + "&FinancialYear=" + financialYear + "&Month=" + month + "&RType=N&Operation=10&SecurityCode=" + pref.getSecurityCode();
        Log.d("input", surl);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, surl,
                new Response.Listener<String>() {
                    @RequiresApi(api = Build.VERSION_CODES.N)
    ...
    private void getItemListForBranch() {
        ...
        pd.setCancelable(false);
        pd.show();
        String surl = AppData.url + "get_EmployeeSalesReport?ClientID=" + pref.getEmpClintId() + "&UserID=" + pref.getEmpId() + "&FinancialYear=" + financialYear + "&Month=" + month + "&RType=B&Operation=10&SecurityCode=" + pref.getSecurityCode();
        Log.d("input", surl);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, surl,
                new Response.Listener<String>() {
                    @RequiresApi(api = Build.VERSION_CODES.N)
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i=0;i<responseData.length();i++) {
                                    ...
                                    TeamSaleModule cModel=new TeamSaleModule(ZoneID,BranchName+" - "+Zonename,TotalCount);
                                    cModel.setBranchId(BranchID);
                                    itemListForZone.add(cModel);
    ...
    private void setAdapter(){
        TeamSaleAdapter saleAdapter=new TeamSaleAdapter(itemListForZone,TeamSalesActivity.this);
