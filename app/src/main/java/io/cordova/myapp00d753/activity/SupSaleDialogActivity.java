...
public class SupSaleDialogActivity extends AppCompatActivity {
    ...
    private void initialize() {
        prefManager = new Pref(SupSaleDialogActivity.this);

        pd = new ProgressDialog(SupSaleDialogActivity.this);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SupSaleDialogActivity.this, SupSalesManagementDashboardActivity.class);
        ...
        tvMonth.setText("Synopsis For The Month Of " + month + "-2020");
    ...
    public void targetGet() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, surl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(SupSaleDialogActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(SupSaleDialogActivity.this, "volly 2" + error.toString(), Toast.LENGTH_LONG).show();
                Log.e("ert", error.toString());
            }
        }) {

        };
        RequestQueue requestQueue = Volley.newRequestQueue(SupSaleDialogActivity.this);
