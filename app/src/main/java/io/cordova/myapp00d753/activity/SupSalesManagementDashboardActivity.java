...
public class SupSalesManagementDashboardActivity extends AppCompatActivity {
    LinearLayout llSale,llTarget,llVisit,llPerformer,llCusReport;
    ...
    String year,month;
    Pref pref;
    LinearLayout llApproval,llReport;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sup_salesmanagement_dashboard);
        initialize();
        //checksale();
        onClick();
    }
    ...
    private void initialize(){
        pref=new Pref(SupSalesManagementDashboardActivity.this);
        ...
        llPerformer=(LinearLayout)findViewById(R.id.llPerformer);
        llCusReport=(LinearLayout)findViewById(R.id.llCusReport);
    ...
    private void onClick(){
        ...
        llSale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),TeamSalesActivity.class);
        ...
        llCusReport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        llPerformer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               vistPerformerDialog();
            }
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(SupSalesManagementDashboardActivity.this,SuperVisiorDashBoardActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void serachDialog(){
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SupSalesManagementDashboardActivity.this, R.style.CustomDialogNew);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alertDialog.dismiss();
                Intent intent=new Intent(getApplicationContext(),SupEmpTargetActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
    ...
    private void vistserachDialog(){
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alertDialog.dismiss();
                Intent intent=new Intent(getApplicationContext(),SupEmpVistActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                pref.saveFinacialYear(tvYear.getText().toString());
                pref.saveMonth(tvMonth.getText().toString());
    ...
    private void vistPerformerDialog(){
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SupSalesManagementDashboardActivity.this, R.style.CustomDialogNew);
        LayoutInflater inflater = (LayoutInflater)getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View dialogView = inflater.inflate(R.layout.attendancereportsearch, null);
        dialogBuilder.setView(dialogView);
        ...
        TextView tvSYear=(TextView)dialogView.findViewById(R.id.tvSYear);
        TextView tvSMonth=(TextView)dialogView.findViewById(R.id.tvSMonth);
        tvSYear.setText("Select Performer Year");
        tvSMonth.setText("Select Performer Month");
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alertDialog.dismiss();
                Intent intent=new Intent(getApplicationContext(),TopPerformerActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                pref.saveFinacialYear(tvYear.getText().toString());
                pref.saveMonth(tvMonth.getText().toString());
    ...
    private void vistshowYearDialog(){
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SupSalesManagementDashboardActivity.this, R.style.CustomDialogNew);
        LayoutInflater inflater = (LayoutInflater)getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View dialogView = inflater.inflate(R.layout.dialog_year, null);
        dialogBuilder.setView(dialogView);
    ...
    private void vistshowMonthDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SupSalesManagementDashboardActivity.this, R.style.CustomDialogNew);
        LayoutInflater inflater = (LayoutInflater)getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View dialogView = inflater.inflate(R.layout.dialog_month, null);
        dialogBuilder.setView(dialogView);
