...
public class LocationSpinnerAdapter extends ArrayAdapter<MetsoLocationModel> {

    public LocationSpinnerAdapter(Context context, ArrayList<MetsoLocationModel> shitItemList) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        MetsoLocationModel currentItem = getItem(position);
