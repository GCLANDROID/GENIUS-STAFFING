...
public class ResignEmpSalaryActivity extends AppCompatActivity  {
    ...
    private void initialize() {
        ...
        connectionCheck=new NetworkConnectionCheck(ResignEmpSalaryActivity.this);
        rvSalary = (RecyclerView) findViewById(R.id.rvSalary);
        LinearLayoutManager layoutManager = new LinearLayoutManager(ResignEmpSalaryActivity.this, LinearLayoutManager.VERTICAL, false);
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(ResignEmpSalaryActivity.this, "Something went to wrong", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void getPaymentLink(JSONObject jsonObject) {
        ProgressDialog pd=new ProgressDialog(ResignEmpSalaryActivity.this);
    ...
    private void onClick() {
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ResignEmpSalaryActivity.this, ResignEmployeeDashboardActivity.class);
    ...
    private void showYearDialog() {
        year = String.valueOf(y);
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(ResignEmpSalaryActivity.this, R.style.CustomDialogNew);
