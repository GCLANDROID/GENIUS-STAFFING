...
public class CounterVisitReportActivity extends AppCompatActivity {
    ...
    TextView tvYear,tvMonth,tvToolBar1,tvLocation;
    String year;
    ...
    private void initView(){
        ...
        tvLocation.setText("Location: "+pref.getBranchNameForEmp()+" - "+pref.getZoneNameForEmp());
        pref.saveXYZ("emp");
    ...
    public void loadYTDFragment() {
        ...
        CounterVisitYTDFragment pfragment=new CounterVisitYTDFragment();
    ...
    public void loadQTEDFragment() {
        ...
        FragmentManager manager = getSupportFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        CounterVisitQTDFragment efr=new CounterVisitQTDFragment();
    ...
    public void loadMTDFragment() {
        ...
        FragmentManager manager = getSupportFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        CounterVisitMTDFragment htfragment=new CounterVisitMTDFragment();
    ...
    public void loadDailySaleFragment() {
        ...
        FragmentManager manager = getSupportFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        DailyCounterVisitReportFragment htfragment=new DailyCounterVisitReportFragment();
        transaction.replace(R.id.frameLayout, htfragment);
        transaction.commit();
    ...
    public void loadWTDFragment() {
        ...
        FragmentManager manager = getSupportFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        CounterVisitWTDFragment htfragment=new CounterVisitWTDFragment();
        transaction.replace(R.id.frameLayout, htfragment);
        transaction.commit();
    ...
    private void serachDialog(){
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(CounterVisitReportActivity.this, R.style.CustomDialogNew);
