...
public class MetsoReimbursementReportActivity extends AppCompatActivity {
    private static final String TAG = "MetsoReimbursementRepor";
    RecyclerView rvItem;
    ...
    private void initialize() {
        ...
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(MetsoReimbursementReportActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void setAdapter() {
        MetsoReimbursementReportAdapter claimAdapter = new MetsoReimbursementReportAdapter(MetsoReimbursementReportActivity.this,itemList);
    ...
    private void onClick(){
        imgSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(MetsoReimbursementReportActivity.this, R.style.CustomDialogNew);
