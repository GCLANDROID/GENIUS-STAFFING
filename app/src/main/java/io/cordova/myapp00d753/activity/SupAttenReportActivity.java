...
public class SupAttenReportActivity extends AppCompatActivity {
    ...
    AttendanceReportAdapter attendanceAdapter;
    String year;
    int y;
    TextView tvYear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sup_atten_report);
        mPageCount=1;
        initialize();
    ...
    private  void  initialize(){
        pref=new Pref(SupAttenReportActivity.this);
        connectionCheck=new NetworkConnectionCheck(SupAttenReportActivity.this);
        rvAttendanceReport=(RecyclerView)findViewById(R.id.rvAttendanceReport);
        layoutManager
                = new LinearLayoutManager(SupAttenReportActivity.this, LinearLayoutManager.VERTICAL, false);
                    ...
                    public void onResponse(String response) {
                       ...
                       //          Toast.makeText(getApplicationContext(),responseText,Toast.LENGTH_LONG).show();
                                ...
                                for (int i = 0; i < responseData.length(); i++){
                                    ...
                                    AttendancereportModule obj2 = new AttendancereportModule(AttendanceDate,AttendanceInDateTime,AttendanceOutDateTime,Address,ApproverStatus,AttendanceType,Name);
                            ...
                            e.printStackTrace();
                            Toast.makeText(SupAttenReportActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
    ...
    private  void setAdapter(){
        attendanceAdapter=new AttendanceReportAdapter(attendabceInfiList);
