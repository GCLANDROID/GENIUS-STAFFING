...
public class ZoneSaleReportActivity extends AppCompatActivity {
    ...
    private void initView(){
        pref=new Pref(ZoneSaleReportActivity.this);
        ...
        tvToolBar.setText("Zone Synopsis - 2020-21");
    ...
    public void loadNormalFragment() {
        ...
        DataFragment pfragment=new DataFragment();
    ...
    public void loadGraphicalFragment() {
        ...
        FragmentManager manager = getSupportFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        GrpahicalFragment pfragment=new GrpahicalFragment();
        transaction.replace(R.id.frameLayout1, pfragment);
        transaction.commit();
    ...
    private void onClick(){
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ZoneSaleReportActivity.this,SuperVisiorDashBoardActivity.class);
