...
public class ProtectorGambleAttendanceActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener{
    ...
    private void openShiftAndLocationPopup2() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(ProtectorGambleAttendanceActivity.this, R.style.CustomDialogNew2);
    ...
    private void intiView() {
        ...
        pref = new Pref(ProtectorGambleAttendanceActivity.this);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (object.getBoolean("responseStatus") == true) {
                                ...
                                progressDialog.cancel();
                                Toast.makeText(ProtectorGambleAttendanceActivity.this, object.getString("responseText"), Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
    ...
    private void successAlert(String message) {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(ProtectorGambleAttendanceActivity.this, R.style.CustomDialogNew);
        LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                    ...
                    public void onMapReady(@NonNull GoogleMap googleMap) {
                        ...
                        if (location != null) {
                            try {
                                ...
                                Geocoder geocoder = new Geocoder(ProtectorGambleAttendanceActivity.this, Locale.getDefault());
    ...
    protected synchronized void buildGoogleApiClient() {
        mGoogleClient = new GoogleApiClient.Builder(ProtectorGambleAttendanceActivity.this)
                .addConnectionCallbacks(this)
                .addOnConnectionFailedListener(this)
                .addApi(LocationServices.API)
                .build();
    ...
    public void onConnected(@Nullable Bundle bundle) {
        if (ContextCompat.checkSelfPermission(ProtectorGambleAttendanceActivity.this,
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        if (connectionResult.hasResolution()) {
            try {
                ...
                connectionResult.startResolutionForResult(ProtectorGambleAttendanceActivity.this, CONNECTION_FAILURE_RESOLUTION_REQUEST);
                /*
    ...
    private void checkLocationPermission() {
        if (ContextCompat.checkSelfPermission(ProtectorGambleAttendanceActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)
                != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(ProtectorGambleAttendanceActivity.this,
                    Manifest.permission.ACCESS_FINE_LOCATION)) {

                // Show an explanation to the user *asynchronously* -- don't block
                // this thread waiting for the user's response! After the user
                // sees the explanation, try again to request the permission.
                new AlertDialog.Builder(ProtectorGambleAttendanceActivity.this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(ProtectorGambleAttendanceActivity.this,
        ...
        switch (requestCode) {
            ...
            case MY_PERMISSIONS_REQUEST_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(ProtectorGambleAttendanceActivity.this, "permission denied", Toast.LENGTH_LONG).show();
                }
                return;
            }
