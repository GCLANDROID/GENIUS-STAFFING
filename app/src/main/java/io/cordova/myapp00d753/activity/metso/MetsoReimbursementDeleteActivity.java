...
import io.cordova.myapp00d753.activity.metso.adapter.MetsoReimbursementClaimDeleteAdapter;
...
public class MetsoReimbursementDeleteActivity extends AppCompatActivity {
    private static final String TAG = "MetsoReimbursementDelet";
    ...
    private void initialize() {
        ...
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(MetsoReimbursementDeleteActivity.this, LinearLayoutManager.VERTICAL, false);
        ...
        AndroidNetworking.post(AppData.GET_REIMBURSEMENT_CLAIM)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            Log.e(TAG, "MERSO_REIMBURSEMENT_DELETE: "+response.toString(4));
                            ...
                            if (Response_Code.equals("101")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    String costCenter = job.optString("CostCenter"),
                                            ...
                                            siteName=job.optString("SiteName"),supervisor = job.optString("Supervisor");
                                    ClaimDeleteModule obj2 = new ClaimDeleteModule(ClaimedDate, Amount, Category, ProcessStaus, ClaimID,costCenter,wbsCode,siteName,supervisor);
                                    itemList.add(obj2);
                                }
                    ...
                    public void onError(ANError anError) {
                        Log.e(TAG, "MERSO_REIMBURSEMENT_DELETE_error: "+anError.getErrorBody());
                        llLoder.setVisibility(View.GONE);
                        llMain.setVisibility(View.GONE);
                        llNodata.setVisibility(View.GONE);
    ...
    private void setAdapter() {
        delAdapter = new MetsoReimbursementClaimDeleteAdapter(itemList, MetsoReimbursementDeleteActivity.this);
    ...
    private void onClick() {
        imgSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(MetsoReimbursementDeleteActivity.this, R.style.CustomDialogNew);
        ...
        llDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (flag > 0){
                    ...
                    Toast.makeText(MetsoReimbursementDeleteActivity.this, "Please Select Reimbursement", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MetsoReimbursementDeleteActivity.this, NewUserDashboardActivity.class);
        ...
        for (int i = 0; i < itemList.size(); i++) {
            if (itemList.get(i).isSelected()){
                if (reimbursementID.isEmpty()){
                    reimbursementID = itemList.get(i).getClaimId();
                } else {
                    reimbursementID += ","+itemList.get(i).getClaimId();
                }
            }
        }
        Log.e(TAG, "deleteOperation: reimbursementID: "+reimbursementID);
        empId = reimbursementID;
        itemdelete();
    }
    ...
    public void updateAttendanceStatus(int position, boolean status) {
        ...
        Log.e(TAG, "updateAttendanceStatus: "+flag);
