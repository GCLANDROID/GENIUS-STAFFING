...
public class SaleTarget extends AppCompatActivity {
    ...
    private void initView(){
        ...
        tvEmpName.setText(pref.getEmpName()+"-"+pref.getFinacialYear());
    ...
    private void showMonthDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SaleTarget.this, R.style.CustomDialogNew);
