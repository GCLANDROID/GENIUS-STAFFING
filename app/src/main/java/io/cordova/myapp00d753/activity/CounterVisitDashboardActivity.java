...
public class CounterVisitDashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_counter_visit_dashboard);
        initView();
        onClick();
    }

    private void initView(){
        pref=new Pref(CounterVisitDashboardActivity.this);
    ...
    private void onClick(){
        llManage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(CounterVisitDashboardActivity.this,CounterVisitEntryActivity.class);
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(CounterVisitDashboardActivity.this,EmployeeDashBoardActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void serachDialog(){
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(CounterVisitDashboardActivity.this, R.style.CustomDialogNew);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alertDialog.dismiss();
                alertDialog.dismiss();
                Intent intent=new Intent(CounterVisitDashboardActivity.this,CounterVisitReportActivity.class);
